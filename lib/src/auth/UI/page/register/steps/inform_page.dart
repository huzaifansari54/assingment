...
class InfoFormWidget extends ConsumerStatefulWidget {
  InfoFormWidget({
    super.key,
  });
  ...
  @override
  ConsumerState<InfoFormWidget> createState() => _InfoFormWidgetState();
}
              ...
              children: [
                ...
                ArrowWidget(onBack: () {
                  ...
                  if (_formKey.currentState!.validate()) {
                    Navigator.pushNamed(
                        context, BessinessHoursFormWidget.routeName);
                    ;
                  }
                }),
              ],
