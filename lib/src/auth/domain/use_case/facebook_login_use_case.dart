...
class FacebookLoginUseCase extends UseCase<UserModelInfo, Unit> {
  final $AuthRepository _repository;

  FacebookLoginUseCase({required $AuthRepository repository})
      : _repository = repository;
  @override
  TaskEither<AuthFailure, Unit> call({required UserModelInfo param}) {
    return _repository.signWithfaceBook();
  }
}
